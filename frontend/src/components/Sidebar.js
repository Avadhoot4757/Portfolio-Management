...
const Sidebar = () => {
  const resolveNavClass = ({ isActive }) =>
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        <NavLink className={resolveNavClass} to="/" aria-label="Dashboard" end>
          <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" />
          </svg>
          <span className="tooltip">Dashboard</span>
        </NavLink>
        <NavLink className={resolveNavClass} to="/holdings" aria-label="Holdings">
          <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M4 4h16v4H4V4zm0 6h16v10H4V10zm4 3v4h8v-4H8z" />
          </svg>
          <span className="tooltip">Holdings</span>
        </NavLink>
        <NavLink className={resolveNavClass} to="/performance" aria-label="Performance">
          <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M4 19h16v2H4v-2zm2-2h3V7H6v10zm5 0h3V3h-3v14zm5 0h3v-6h-3v6z" />
          </svg>
          <span className="tooltip">Performance</span>
        </NavLink>
        <NavLink className={resolveNavClass} to="/watchlist" aria-label="Watchlist">
          <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M12 3.5l2.68 5.42 5.98.87-4.33 4.22 1.02 5.95L12 16.9l-5.35 2.81 1.02-5.95-4.33-4.22 5.98-.87L12 3.5z" />
          </svg>
          <span className="tooltip">Watchlist</span>
        </NavLink>
        <NavLink className={resolveNavClass} to="/settings" aria-label="Settings">
          <svg className="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
